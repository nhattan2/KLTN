...
function Register() {
    ...
    const handleSubmit = (e) => {
        ...
        const dataToSend = {
            // MẶC ĐỊNH GÁN QUYỀN USER CHO MỌI TÀI KHOẢN ĐĂNG KÝ MỚI
            role: 'user'
        };

        // Chỉ thêm các trường có nhập dữ liệu
        ...
        axios.post('http://localhost:3001/register', dataToSend)
            ...
            .catch(() => alert("Thông tin (Email/SĐT/CCCD) đã tồn tại trong hệ thống!"));
    };
            ...
            <div className="auth-card" style={{ maxWidth: '480px' }}>
                ...
                <form onSubmit={handleSubmit} style={{ marginTop: '1.5rem' }}>
                    ...
                    <input
                        ...
                        style={{ marginTop: '10px' }}
                    />
                    <button type="submit" className="btn-secondary" style={{ marginTop: '20px' }}>
                        Đăng ký ngay
                    </button>
                </form>
